...
```{r Kalman Filter , echo=FALSE, results='hide', keep.fig='all'}
######online learning
# static 
...
experts <- cbind(gam9.forecast, pred2,rf.forecast, gam.forecast, gam9.kalman.Dyn, arima.predict, as.numeric(gam9.arima.forecast))%>%as.matrix
...
models = c(Data1$Load, pred2, rf.forecast, gam.forecast, gam9.forecast, gam9.kalman.Dyn, gam9.arima.forecast, agg$prediction)
K <-ncol(models)
